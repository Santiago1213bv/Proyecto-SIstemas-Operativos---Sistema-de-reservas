...
extern char nombreAgente[MAX_NOMBRE];
extern char archivoSolicitudes[128];
extern char pipeRecibe[MAX_PIPE_NAME];
extern char pipeRespuesta[MAX_PIPE_NAME];
extern int fd_pipe_controlador;
extern int fd_pipe_respuesta;
